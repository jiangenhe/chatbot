...
class ChatBot extends Component {
  ...
  componentDidMount() {
    ...
    const defaultBotSettings = { delay: botDelay, avatar: botAvatar, name: botName };
  ...
  triggerNextStep = data => {
    ...
    if (isEnd) {
      ...
      if (currentStep.asOption) {
        ...
        trigger = this.getTriggeredStep(option.trigger,
          currentStep.value);
      }
  ...
  renderStep = (step, index) => {
    ...
    const { options, component, asMessage, asOption } = step;
    const steps = this.generateRenderedStepsById();
